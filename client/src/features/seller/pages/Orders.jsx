        ...
        {orders.map((order, index) => (
          ...
          >
            ...
            {expandedOrders[order._id] && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:divide-x divide-gray-100 animate-fadeIn bg-white">
                ...
                <div className="lg:col-span-1 p-5 bg-gray-50/30 space-y-6 border-l border-gray-100">
